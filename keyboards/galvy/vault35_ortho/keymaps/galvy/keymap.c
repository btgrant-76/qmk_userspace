...
enum custom_keycodes {
  ...
  KORLN,
  ALTV,CTRLB, // lower row mod alternatives
...
const uint16_t PROGMEM ENT_combo[] = {KC_L, LT(L_NAV,KC_SLSH), COMBO_END};
const uint16_t PROGMEM QUO_combo[] = {KC_L, KC_SCLN, COMBO_END};
const uint16_t PROGMEM FTW_combo[] = {KC_LBRC, KC_RBRC, COMBO_END};
const uint16_t PROGMEM FON_combo[] = {KC_F2, KC_F3, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
 LT(L_NAV,KC_Z),  KC_X,    KC_C,    KC_V,    KC_B,_______,KC_N, KC_M, KC_COMM,  KC_DOT, LT(L_NAV,KC_SLSH),
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
                KC_LGUI,LT(L_LOW,KC_TAB), KC_LSFT, _______, KC_SPC,MO(L_RAI),LT(L_SPC,KC_RALT)
                    //|--------+--------+--------+--------+--------+--------+--------|
  ), [L_LOW] = LAYOUT(
  //|--------------------------------------------|--------|--------------------------------------------|
         KC_1,    KC_2,    KC_3,    KC_4,    KC_5, _______,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
       KC_GRV, _______, _______, _______, _______, _______, KC_BSLS, KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC,
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
      KC_TILD, _______, _______, _______, _______, _______, KC_PIPE, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR,
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
      _______,KC_MS_BTN2,KC_MS_BTN3,KC_MS_BTN1,_______,_______,KC_LEFT,KC_DOWN, KC_UP,KC_RIGHT,   RPIPE,
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
      _______, _______, _______,  KC_DEL, KC_BSPC, _______, _______, _______,   RASGN, _______, _______,
  //|--------+--------+--------+--------+--------|--------|--------+--------+--------+--------+--------|
                        _______, _______, _______, KC_PSCR, _______, _______,   KORLN
                    //|--------+--------+--------+--------+--------+--------+--------|
  ), [L_NUM] = LAYOUT(
  //|--------------------------------------------|--------|--------------------------------------------|
         KC_1,    KC_2,    KC_3,    KC_4,    KC_5, _______,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
